# Instructions
1. Ensure you are in the correct directory. You should be in the bot-o-mat-Soham231 directory.
2. Run the program with the command 'java -cp ../bin src/main'. Enjoy!
